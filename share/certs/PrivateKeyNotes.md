...
unlocked to sign the BTCr-Qt.app bundle.
...
allowing somebody to distribute a BTCr-Qt.app or btcr-qt-setup.exe with a valid
...
that the btcr-qt.exe file inside the installer had not been tampered with.
