...
class WalletTest (BTCrTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 BTCr from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 BTCr in block rewards plus fees, but
        ...
        # Send 100 BTCr with subtract fee from amount
        ...
        # Sendmany 100 BTCr with subtract fee from amount
