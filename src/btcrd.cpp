 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called BTCr (https://www.btcr.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "BTCr Core server starting\n");
