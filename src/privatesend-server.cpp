...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all BTCr related functionality
...
/*
    ...
    allow endless transaction that would bloat BTCr and make it unusable. To
