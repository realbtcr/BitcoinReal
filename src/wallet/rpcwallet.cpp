...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new BTCr address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"btcraddress\"    (string) The new btcr address\n"
            "\nExamples:\n"
    ...
    return CBTCrAddress(keyID).ToString();
}


CBTCrAddress GetAccountAddress(string strAccount, bool bForceNew=false)
{
    ...
    return CBTCrAddress(account.vchPubKey.GetID());
}
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current BTCr address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"btcraddress\"   (string) The account btcr address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new BTCr address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"btcraddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"btcraddress\"  (string, required) The btcr address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", \"tabby\"")
        );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    CBTCrAddress address(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BTCr address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"btcraddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"btcraddress\"  (string, required) The btcr address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\"")
            + HelpExampleRpc("getaccount", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\"")
        );
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"btcraddress\"  (string) a btcr address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
    ...
    BOOST_FOREACH(const PAIRTYPE(CBTCrAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        const CBTCrAddress& address = item.first;
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"btcraddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"btcraddress\" (string, required) The btcr address to send to.\n"
            ...
            "                             The recipient will receive less amount of BTCr than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"btcraddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"btcraddress\"  (string, required) The btcr address to send to.\n"
            "2. \"amount\"      (numeric, required) The amount in BTCr to send. eg 0.1\n"
            "3. \"comment\"     (string, optional) A comment used to store what the transaction is for. \n"
            "                             This is not part of the transaction, just kept in your wallet.\n"
            "4. \"comment-to\"  (string, optional) A comment to store the name of the person or organization \n"
            "                             to which you're sending the transaction. This is not part of the \n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"btcraddress\",     (string) The btcr address\n"
    ...
    BOOST_FOREACH(set<CTxDestination> grouping, pwalletMain->GetAddressGroupings())
    {
        ...
        BOOST_FOREACH(CTxDestination address, grouping)
        {
            ...
            addressInfo.push_back(CBTCrAddress(address).ToString());
            addressInfo.push_back(ValueFromAmount(balances[address]));
            {
                if (pwalletMain->mapAddressBook.find(CBTCrAddress(address).Get()) != pwalletMain->mapAddressBook.end())
                    addressInfo.push_back(pwalletMain->mapAddressBook.find(CBTCrAddress(address).Get())->second.name);
            }
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"btcraddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"btcraddress\"  (string, required) The btcr address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"btcraddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given btcraddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            "1. \"btcraddress\"  (string, required) The btcr address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", 6")
       );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    // BTCr address
    CBTCrAddress address = CBTCrAddress(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BTCr address");
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tobtcraddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a btcr address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"tobtcraddress\"  (string, required) The btcr address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    string strAccount = AccountFromValue(params[0]);
    CBTCrAddress address(params[1].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BTCr address");
    CAmount nAmount = AmountFromValue(params[2]);
    if (nAmount <= 0)
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The btcr address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less btcrs than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    {
        CBTCrAddress address(name_);
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid BTCr address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a BTCr address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of btcr addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) btcr address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"btcraddress\"  (string) A btcr address associated with the keys.\n"
    ...
    return CBTCrAddress(innerID).ToString();
}
...
UniValue ListReceived(const UniValue& params, bool fByAccounts)
{
    ...
    // Tally
    map<CBTCrAddress, tallyitem> mapTally;
    for (map<uint256, CWalletTx>::iterator it = pwalletMain->mapWallet.begin(); it != pwalletMain->mapWallet.end(); ++it)
    {
        const CWalletTx& wtx = (*it).second;
    ...
    BOOST_FOREACH(const PAIRTYPE(CBTCrAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        ...
        map<CBTCrAddress, tallyitem>::iterator it = mapTally.find(address);
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"btcraddress\",  (string) The btcr address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"btcraddress\",  (string) The btcr address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"btcraddress\",      (string) The btcr address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending btcrs\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending btcr\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"btcraddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; BTCr Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending btcrs.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of btcr addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) btcr address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the btcr address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\\\",\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"54JErfxcQvkMNN2BqzsMFEdvD8TcQrrQA7\\\",\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            CBTCrAddress address(input.get_str());
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid BTCr address: ")+input.get_str());
            if (setAddress.count(address))
    ...
    BOOST_FOREACH(const COutput& out, vecOutputs) {
        ...
        CTxDestination address;
        if (ExtractDestination(out.tx->vout[out.i].scriptPubKey, address)) {
            entry.push_back(Pair("address", CBTCrAddress(address).ToString()));
