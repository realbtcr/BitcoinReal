...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/btcr"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BTCr Core"),
     ...
     * override -datadir in the btcr.conf file in the default data directory
     * (to be consistent with btcrd behavior)
     */
