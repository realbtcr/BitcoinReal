...
#include "config/btcr-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBTCrURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BTCrUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBTCrURI(info));
}
