...
#ifndef BTCr_QT_BTCrUNITS_H
#define BTCr_QT_BTCrUNITS_H
...
/** BTCr unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BTCrUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BTCrUnits(QObject *parent);

    /** BTCr units.
      @note Source: https://en.btcr.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTCr,
...
typedef BTCrUnits::Unit BTCrUnit;

#endif // BTCr_QT_BTCrUNITS_H
