    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BTCr-light"), QVariant("light"));
    ui->theme->addItem(QString("BTCr-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BTCr-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BTCr-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BTCr-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new BTCrUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->btcrAtStartup, OptionsModel::StartAtStartup);
