...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BTCrUnits::BTCr),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = BTCrUnits::floorWithUnit(unit, amount, true, BTCrUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, BTCrUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, BTCrUnits::separatorAlways));
    ui->labelImmature->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, BTCrUnits::separatorAlways));
    ui->labelAnonymized->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, BTCrUnits::separatorAlways));
    ui->labelTotal->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, BTCrUnits::separatorAlways));
    ui->labelWatchAvailable->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, BTCrUnits::separatorAlways));
    ui->labelWatchPending->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, BTCrUnits::separatorAlways));
    ui->labelWatchImmature->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, BTCrUnits::separatorAlways));
    ui->labelWatchTotal->setText(BTCrUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, BTCrUnits::separatorAlways));
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = BTCrUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, BTCrUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), BTCrUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = BTCrUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, BTCrUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), BTCrUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(BTCrUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(BTCrUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
