...
#ifndef BTCr_TEST_SCRIPTNUM10_H
#define BTCr_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BTCr Core 0.10.0, for cross-comparison.
 */
public:
