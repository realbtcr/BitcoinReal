...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBTCrAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBTCrAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CBTCrAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBTCrAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBTCrAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBTCrAddress(arr[0].get_str()).Get() == demoAddress.Get());
