...
This document provides guidelines for internationalization of the BTCr Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `btcr_en.ts` remains unchanged.
