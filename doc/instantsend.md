...
This mechanism has been integrated into Bitcore-Node-BTCr which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/btcrcrypto/insight-api-btcr#web-socket-api](https://github.com/btcrcrypto/insight-api-btcr#web-socket-api)
* API: [https://github.com/btcrcrypto/insight-api-btcr#instantsend-transactions](https://github.com/btcrcrypto/insight-api-btcr#instantsend-transactions)
...
By default, the BTCr Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BTCr Core daemon:
