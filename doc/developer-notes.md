...
BTCr Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- BTCrMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as BTCr Core, where everyone uses
...
pay attention to for reviewers of BTCr Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BTCr Core uses tinyformat, which is type safe. Leave them out to avoid confusion
